...
val realmData = arrayOf(
    ...
    MeasureUnit(2, TYPE_NORMAL, 0, "kg", "킬로그램", "", 1000.0, true, Date().time, Date().time),
    MeasureUnit(3, TYPE_NORMAL, 0, "lb", "파운드","",453.59237,true,Date().time, Date().time),
    MeasureUnit(4, TYPE_NORMAL,0,"cc","시시","",1.0,false,Date().time, Date().time),
    MeasureUnit(5, TYPE_NORMAL,0,"L","리터","",1000.0,false,Date().time, Date().time),
    MeasureUnit(6, TYPE_NORMAL,0,"ml", "밀리리터","",1.0,false,Date().time, Date().time),
    MeasureUnit(7, TYPE_NORMAL, 0,"큰술","tbsp","",15.0,false,Date().time, Date().time),
    MeasureUnit(8, TYPE_NORMAL,0,"작은술","tsp","",5.0,false,Date().time, Date().time),
    MeasureUnit(9, TYPE_NORMAL,0,"oz", "온즈","",29.57353,false,Date().time, Date().time),
    MeasureUnit(10, TYPE_NORMAL,0,"컵","cup","",200.0,false,Date().time, Date().time),
    MeasureUnit(11, TYPE_NORMAL,0,"us컵","cup","",240.0,false,Date().time, Date().time),

    MeasureUnit(12, TYPE_LIFE, 0,"밥숟가락","","",10.0,false,Date().time, Date().time),
    MeasureUnit(13, TYPE_LIFE,0,"베라스푼","","",5.0,false,Date().time, Date().time),
    MeasureUnit(14, TYPE_LIFE,0,"종이컵","","",180.0,false,Date().time, Date().time),
    MeasureUnit(15, TYPE_LIFE,0,"소주잔","","",50.0,false,Date().time, Date().time),
    MeasureUnit(16, TYPE_LIFE,0,"병뚜껑", "","",5.0,false,Date().time, Date().time),
    MeasureUnit(17, TYPE_LIFE, 0,"물뚜껑","","",5.0,false,Date().time, Date().time),
    MeasureUnit(18, TYPE_LIFE,0,"작은김용기","","",70.0,false,Date().time, Date().time),
    MeasureUnit(19, TYPE_LIFE,0,"큰김용기","","",100.0,false,Date().time, Date().time),
    MeasureUnit(20, TYPE_LIFE,0,"참치캔","","",200.0,false,Date().time, Date().time),
    MeasureUnit(21, TYPE_LIFE,0,"햇반그릇","","",210.0,false,Date().time, Date().time),
