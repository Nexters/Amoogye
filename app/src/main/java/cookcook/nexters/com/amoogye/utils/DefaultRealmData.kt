...
val realmData = arrayOf(
    ...
    MeasureUnit(1, TYPE_LIFE, 0,"밥숟가락","","",10.0,false,Date().time, Date().time),
    MeasureUnit(2, TYPE_LIFE,0,"베라스푼","","",5.0,false,Date().time, Date().time),
    MeasureUnit(3, TYPE_LIFE,0,"종이컵","","",180.0,false,Date().time, Date().time),
    MeasureUnit(4, TYPE_LIFE,0,"소주잔","","",50.0,false,Date().time, Date().time),
    MeasureUnit(5, TYPE_LIFE,0,"병뚜껑", "","",5.0,false,Date().time, Date().time),
    MeasureUnit(6, TYPE_LIFE, 0,"물뚜껑","","",5.0,false,Date().time, Date().time),
    ...
    MeasureUnit(11, TYPE_NORMAL, 0, "g", "그램", "", 1.0, true, Date().time, Date().time),
    MeasureUnit(12, TYPE_NORMAL, 0, "kg", "킬로그램", "", 1000.0, true, Date().time, Date().time),
    MeasureUnit(13, TYPE_NORMAL, 0, "lb", "파운드","",453.59237,true,Date().time, Date().time),
    MeasureUnit(14, TYPE_NORMAL,0,"cc","시시","",1.0,false,Date().time, Date().time),
    MeasureUnit(15, TYPE_NORMAL,0,"L","리터","",1000.0,false,Date().time, Date().time),
    MeasureUnit(16, TYPE_NORMAL,0,"ml", "밀리리터","",1.0,false,Date().time, Date().time),
    MeasureUnit(17, TYPE_NORMAL, 0,"큰술","tbsp","",15.0,false,Date().time, Date().time),
    MeasureUnit(18, TYPE_NORMAL,0,"작은술","tsp","",5.0,false,Date().time, Date().time),
